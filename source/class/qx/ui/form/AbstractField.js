  ...
  */
  ...
  members: {
    ...
    */
    ...
    _onHtmlInput(e) {
      var value = e.getData();
      var casedValue; // https://jira.rocketsoftware.com/browse/LS-16979 - [#LS-16979] Web client: Using field uppercase repositions the cursor incorrectly
      var fireEvents = true;
      var filteredValue = "";
      ...
      //https://jira.rocketsoftware.com/browse/LWEB-805 - [#LWEB-805] Start using qooxdoo library from github fork
