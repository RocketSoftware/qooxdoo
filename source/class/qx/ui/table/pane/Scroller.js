...
qx.Class.define("qx.ui.table.pane.Scroller", {
  ...
  */
  ...
  properties: {
    ...
    //  https://jira.rocketsoftware.com/browse/LWEB-574 - [#LWEB-574] Scrollbar button event for Grid
    /**
  ...
  members: {
    ...
    _createChildControlImpl(id, hash) {
      ...
      switch (id) {
        ...
        case "scrollbar-x":
          ...
          control.addListener("changeVisibility", this.__onChangeScrollbarVisibility, this); // https://jira.rocketsoftware.com/browse/LS-21550 - [#LS-21550] LegaSuite Web does not swipe-scroll, pinch and zoom well on Android phone
    ...
    updateVerScrollBarMaximum() {
      ...
      if (paneSize.height < scrollSize) {
        ...
        scrollBar.setMaximum(max);
        if(scrollSize - paneSize.height < rowHeight) { //LS-20524-vertical-grid-scroll-bar-miscalculated
          scrollBar.setKnobFactor(1);
        } else {
