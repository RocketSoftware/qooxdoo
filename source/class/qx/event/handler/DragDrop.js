  ...
  members: {
    ...
    */
    ...
    unregisterEvent(target, type, capture) {
      // Nothing needs to be done here
      this.__dragTarget = null; //https://jira.rocketsoftware.com/browse/LS-18169 - [#LS-18169] JavaScript heap is increasing and causing client performance issues over time
      this.__dropTarget = null; //https://jira.rocketsoftware.com/browse/LS-18169 - [#LS-18169] JavaScript heap is increasing and causing client performance issues over time
    },
